        ...
        <div className="main">
            ...
            <div className="container">
                <div className="section-1">
                    <div>
                        <input className="new-meta"
                            type="text"
                            value={newTodo}
                            onChange={(e) => setNewTodo(e.target.value)}
                            placeholder="Nueva Tarea"
                        />
                        <button className="btn" onClick={addTodo}>Agregar</button>
                    </div>
                </div>
                <div className="section-2">
                    <input className="completadas" value={"Completadas: "} />
                    <input className="pendientes" value={"Pendiente: "} />
                </div>
                <div className="section-3">
                    <input className="aprender" value={"Aprender CSS "}/>
                    <ul>
